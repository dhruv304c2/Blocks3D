...
namespace Game.Core
{
    public class GameController: MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _activeFloater = new Floater().InVolume(GameVolume.Self, new Vector3Int(3, 4, 3)).WithColor(BlockColor.Red);
        }

        private void Update()
        {
            if (Input.GetKeyDown(KeyCode.S)) _activeFloater.MoveDown();
        }
    }
}